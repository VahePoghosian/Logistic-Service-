...
namespace LogysticSystemService.Repository
{
	static class Helper
	{
		public static void InitializationCarType(this List<CarType> _carTypes)
		{
		...
		public static void InitializeCarMark(this List<CarMark> _carMarks)
		{
			List<CarModels> carModels = new List<CarModels>();
			carModels.CarModelsInitiakizatin();

			_carMarks.Add(new CarMark("BMW", carModels));
		}

		public static void CarModelsInitiakizatin(this List<CarModels> _carModels)
		{
